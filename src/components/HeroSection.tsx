...
function HeroSection() {
    const slides = [
        {
            id: 1,
            icon: <Leaf className="w-20 h-20 sm:w-28 sm:h-28 text-pink-400 drop-shadow-lg" />,
            title: "Fresh Organic Groceries",
            subtitle: "Farm-Fresh fruits, vegetables, and daily essentials delivered to you.",
            btnText: "Compre Agora",
            bg: "https://images.unsplash.com/photo-1550989460-0adf9ea622e2?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
        },
        {
            id: 2,
            icon: <Truck className="w-20 h-20 sm:w-28 sm:h-28 text-yellow-400 drop-shadow-lg" />,
            title: "Fast & Reliable Delivery",
            subtitle: "We ensure your groceries reach your doorstop in no time.",
            btnText: "Compre Agora",
        ...
        },
        {
            ...
            bg: "https://plus.unsplash.com/premium_photo-1664527305901-a3c8bec62850?q=80&w=870&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
        },
    ]
